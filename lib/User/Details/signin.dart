            ...
            child: Column(
              children: <Widget>[
                Opacity(
                  opacity: 0.88,
                  child: AppBar(
                    backgroundColor: Color(0xFFD3032A),
    ...
    return RaisedButton(
      ...
      onPressed: () async {
        if (_formKey.currentState!.validate()) {
          ...
          print("shared:" + pref.getString('email').toString());
          Navigator.of(context, rootNavigator: true).pushAndRemoveUntil(
              MaterialPageRoute(
                  builder: (context) => Profilepages(_email.toString())),
              (Route<dynamic> route) => false);

          // auth.signInWithEmailAndPassword(email: _email!, password: _password!).then((value) async {
          //   final SharedPreferences pref=await SharedPreferences.getInstance();
          //   pref.setString('email', _email.toString());
          //   print("shared:"+pref.getString('email').toString());
          //   Navigator.of(context,rootNavigator: true).pushAndRemoveUntil(MaterialPageRoute(builder: (context)=>Profilepages(_email.toString())),(Route<dynamic> route)=>false);
          // }).catchError((onError){
